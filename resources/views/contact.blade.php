            ...
            <div class="col-12 col-sm-10 col-lg-6 mx-auto">
                ...
                <form class="bg-white shadow rounded py-3 px-4" method="POST" action="{{route('message.store')}}">
                    ...
                    <div class="form-group">
                        ...
                        type="text" id="name"  name="name" placeholder={{__('Name')}} value={{old('name')}}><br>
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        id="email" type="email" name="email" placeholder={{__('Email')}} value={{old('email')}}><br>
                        @error('email')
                    ...
                    <div class="form-group">
                        ...
                        id="subject" type="text" name="subject" placeholder={{__('Subject')}} value={{old('subject')}}><br>
                        @error('subject')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{$message}}</strong>
                            </span>                    
                    ...
                    <div class="form-group">
                        ...
                        id="content" name="content" placeholder={{__('Message')}} value={{old('content')}}></textarea><br>
                        @error('subject')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{$message}}</strong>
                            </span>                    
                    ...
                    <div class="d-grid">
                        <button class="btn btn-primary" type="button">@lang('Send')</button><br>
                    </div>
                </form>
            </div>
        </div>
